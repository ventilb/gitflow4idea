 ...
 * performs a start feature, publish feature and finish feature workflow.
 *
 * @author <a href="mailto:manuel_schulze@i-entwicklung.de">Manuel Schulze</a>
 * @since 03.07.14 - 21:42
 */
public class TestFixture5 {
    ...
    // File-Handle auf die Remote Repositories für diesen Test
    public File projectRepositoryRemoteRoot;

    public File moduleRepositoryRemoteRoot;

    public TestFixture5(JavaCodeInsightFixtureTestCase javaCodeInsightFixtureTestCase) {
    ...
    public void setUp() throws Exception {
        ...
        TestUtils.startFeature(this.projectGitRepository, "Test-Feature");
        TestUtils.startFeature(this.module1GitRepository, "Test-Feature");

        TestUtils.publishFeature(this.projectGitRepository, "Test-Feature");
        TestUtils.publishFeature(this.module1GitRepository, "Test-Feature");

        TestUtils.finishFeature(this.projectGitRepository, "Test-Feature");
        TestUtils.finishFeature(this.module1GitRepository, "Test-Feature");
